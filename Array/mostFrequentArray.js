...
const max8 = Math.max(...Object.values(lastElement)) 
const key8 = (obj, val8)=>{
    return Object.keys(obj).find((key)=>obj[key]===val8)
}
const eight = key8(lastElement, max8)
// console.log(`more frequent is ${eight} has ${max8} time called`);
